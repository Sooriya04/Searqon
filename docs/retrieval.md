...
![Retrieval Engine Strategy](/home/sooriya/workspace/Searqon/docs/images/retrieval_engine.png)
...
### 1. Pre-Processing
We strip away the noise. The engine uses a high-speed **Regex Preprocessor** to clean the text, remove "stop words" (like *the*, *is*, *at*), and prepare the content for deep analysis.
